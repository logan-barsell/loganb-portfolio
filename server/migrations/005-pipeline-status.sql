-- Remap legacy CRM stages to unified pipeline keys
UPDATE inquiries SET stage = 'sent_proposal' WHERE stage = 'proposal_sent';
UPDATE inquiries SET stage = 'new' WHERE stage = 'qualified';
UPDATE inquiries SET stage = 'active_project' WHERE stage = 'converted';
UPDATE inquiries SET stage = 'cancelled_project' WHERE stage = 'closed';

-- Allow proposal status 'declined' (SQLite cannot alter CHECK; recreate table)
...
INSERT INTO proposals_new (
  id, client_id, inquiry_id, version, status,
